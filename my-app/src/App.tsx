...
function App() {
    ...
    function handleNoteFavorites(event: React.MouseEvent<HTMLButtonElement, MouseEvent>, id:number) {
        ...
        clicked.style.color = clickedNote.favorite ? "#ff0000" : currentTheme.text;
    }
    ...
    function handleEditField(e : React.FormEvent<HTMLElement>, type: string, id:number) {
        ...
        if (type === "heading") {
            ...
            clickedNote.title = element.innerText === "" ? clickedNote.title : element.innerText;
            element.innerText = clickedNote.title;
        } else if (type === "text") {
            element = e.target as HTMLParagraphElement;
            clickedNote.content = element.innerText === "" ? clickedNote.title : element.innerText;
            element.innerText = clickedNote.title;
        } else {
            element = e.target as HTMLParagraphElement;
